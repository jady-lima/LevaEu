...
import 'package:levaeu_mobile/model/user_request.dart';
  ...
  class Race extends ChangeNotifier {
    ...
    Race({
      ...
      if (userRequests != null) _userRequests = userRequests;
    }
    ...
    void updateUserRequests(List<UserRequest> newUserRequests) {
      _userRequests = newUserRequests;
      notifyListeners();
    }
    ...
    factory Race.fromJson(Map<String, dynamic> json) {
      return Race(
        ...
        saidaName: json['ride']['departureLocation']['name'],
        destinoName: json['ride']['destinationLocation']['name'],
        saidaLat: json['ride']['departureLocation']['latitude'],
        saidaLng: json['ride']['departureLocation']['longitude'],
        destinoLat: json['ride']['destinationLocation']['latitude'],
        destinoLng: json['ride']['destinationLocation']['longitude'],
        data: DateTime.parse(json['ride']['departureTime']),
        horario: TimeOfDay.fromDateTime(DateTime.parse(json['ride']['departureTime'])),
        motoristaID: json['driver']['id'].toString(),
